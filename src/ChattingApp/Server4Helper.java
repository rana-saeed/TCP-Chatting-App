...
public class Server4Helper implements Runnable{
	Socket connectionSocket;
	BufferedReader inFromClient;
	DataOutputStream outToClient;
	String sourceName;
	static Socket toServer1  = TCPServer4.serverAsClient;
	static DataOutputStream outToServer1;
	static LinkedHashMap<String, Socket> users = TCPServer4.users;

	public Server4Helper(Socket client, String incoming)
	{
