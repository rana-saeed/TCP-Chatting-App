...
public class Server3Helper implements Runnable{
	Socket connectionSocket;
	BufferedReader inFromClient;
	DataOutputStream outToClient;
	String sourceName;
	static Socket toServer1  = TCPServer3.serverAsClient;
	static DataOutputStream outToServer1;
	static LinkedHashMap<String, Socket> users = TCPServer3.users;

	public Server3Helper(Socket client, String incoming)
	{
