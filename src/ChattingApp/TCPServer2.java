...
public class TCPServer2 {
	...
	public TCPServer2()
	{
		...
		System.out.println("Server 2 is open.");
		Thread t = new Thread()
		{
			public void run()
			{
		...
		while(true)
		{
			try {
				...
				users.put(sourceName,connectionSocket);
				new Thread(new Server2Helper(connectionSocket,sourceName)).start();
	...
	public void connectToServer1()
	{
		try {
			...
			outToServer1.writeBytes("Server 2" + '\n');
		} catch (IOException e) {
			connectToServer1();
		}
	}
